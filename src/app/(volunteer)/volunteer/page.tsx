    ...
    <main className="min-h-screen bg-[#F7F7F8] px-3 sm:px-4 py-6 sm:py-8">
      <div className="max-w-2xl mx-auto">
        <div className="mb-6 sm:mb-8">
          <span className="inline-block bg-[#00666B] text-white text-xs font-bold px-3 py-1 rounded-full mb-3 uppercase tracking-widest">
            Volunteer
          </span>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-6 sm:mb-8">
          ...
          <button
            ...
            className="bg-white text-[#051B1D] border-2 border-black rounded-2xl px-4 py-4 sm:py-5 font-black text-xs sm:text-sm shadow-[3px_3px_0px_#000] sm:shadow-[4px_4px_0px_#000] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px] transition-all text-left"
          >
            <p className="text-xl sm:text-2xl mb-2">📋</p>
            View Events
          </button>
